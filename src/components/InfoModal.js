    ...
    >
      <div className={mobile ? "ModalBox ModalBox-mobile" : "ModalBox"}>
        ...
        <p style={{ fontSize: "14px" }}>
          ...
          <br />
          Re-made by <a href="https://github.com/reneeste/">Renee</a>: re-coded and optimized lyric scraper, re-factored for multiple artist functionality, changed some design.
          <br />
        </p>
